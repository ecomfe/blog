...
![Chrome 的开发工具显示元素宽度为 620px。](/blog/images/responsive-images-in-practice/box-model.png)
...
![一幅页面数据量和窗口宽度关系的图表。顶部有一条平线，而下方有一条阶梯式的曲线。](/blog/images/responsive-images-in-practice/first-pass.svg)
...
![一段动画演示，展现了细节图在窄屏上变得多小，而在呈现另一种裁切方式时能得到多少更丰富的细节。](/blog/images/responsive-images-in-practice/art-direction.gif)
...
![第三幅展示页面数据量和窗口宽度关系的图表。](/blog/images/responsive-images-in-practice/third-pass.svg)
