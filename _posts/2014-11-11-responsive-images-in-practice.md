...
![Chrome 的开发工具显示元素宽度为 620px。]({{ site.github.url }}/images/responsive-images-in-practice/box-model.png)
...
![一幅页面数据量和窗口宽度关系的图表。顶部有一条平线，而下方有一条阶梯式的曲线。]({{ site.github.url }}/images/responsive-images-in-practice/first-pass.svg)
...
![一段动画演示，展现了细节图在窄屏上变得多小，而在呈现另一种裁切方式时能得到多少更丰富的细节。]({{ site.github.url }}/images/responsive-images-in-practice/art-direction.gif)
...
![另一幅展示页面数据量和窗口宽度关系的图表。]({{ site.github.url }}/images/responsive-images-in-practice/second-pass.svg)
...
![第三幅展示页面数据量和窗口宽度关系的图表。]({{ site.github.url }}/images/responsive-images-in-practice/third-pass.svg)
